...
return [
    ...
    */
    ...
    'name' =>  env('APP_API') ? 'api.' . env('APP_NAME', 'Dropwow') : env('APP_NAME', 'Dropwow'),
    ...
    */
    ...
    'is_api' => env('APP_API', false)
    /**
     * Открываем файл с ошибкой сразу в шторме.
     * только локально
     */
    /*'editor' => function ($file, $line) {
        $file = str_replace("/var/www/dropwow", env("APP_DIR", ""), $file);
